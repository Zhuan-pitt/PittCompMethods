...
for(double i = 1; i<5; i++){
    SimpleRKStepper stepper_e(EulerTableau(), h / pow(10,i));
    RKIntegrator integrator_e(&stepper_e);
    SimpleRKStepper stepper_m(MidpointTableau(), h / pow(10,i));
    RKIntegrator integrator_m(&stepper_m);
    SimpleRKStepper stepper_t(TrapezoidTableau(), h / pow(10,i));
    RKIntegrator integrator_t(&stepper_t);
    SimpleRKStepper stepper_c(ClassicalRungeKuttaTableau(), h / pow(10,i));
